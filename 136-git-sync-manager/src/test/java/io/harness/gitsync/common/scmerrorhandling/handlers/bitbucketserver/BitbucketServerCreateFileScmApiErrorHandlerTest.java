...
public class BitbucketServerCreateFileScmApiErrorHandlerTest extends GitSyncTestBase {
  @Inject BitbucketServerCreateFileScmApiErrorHandler bitbucketServerCreateFileScmApiErrorHandler;
